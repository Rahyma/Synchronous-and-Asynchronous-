...
if(isset($_GET['UpdateSchool'])) {
  ...
  //Update Data if no Error
    ...
    $query1 = "UPDATE students SET school_name='$school_name',area='$area',location='$location',rank1='$rank1',board='$board',mont_fees='$mont_fees',elementary_fees='$elementary_fees',sec_fees='$sec_fees',branch='$branch'
    WHERE school_name ='$school_name'";
 ...
 // echo $data;
  ...
  if ($data1) {
    echo "\nSynchronously data update successfully";
